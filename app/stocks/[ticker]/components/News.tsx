...
function timeAgo(publishTime: string | number | Date) {
  let publishDate: Date
  if (publishTime instanceof Date) {
    publishDate = publishTime
  } else if (typeof publishTime === "number") {
    // Assume seconds if small number, else ms
    publishDate = new Date(publishTime < 100000000000 ? publishTime * 1000 : publishTime)
  } else {
