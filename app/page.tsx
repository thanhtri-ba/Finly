...
export default async function Home({
  ...
  const news = await fetchStockSearch("^DJI", 3)
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-col gap-4 lg:flex-row">
        <div className="w-full lg:w-1/2">
          <Card className="relative flex h-full min-h-[15rem] flex-col justify-between overflow-hidden">
            ...
            <CardFooter className="flex-col items-start gap-4 z-50">
              ...
              <div className="flex flex-col gap-3 w-full">
                {news.news.map((item: any, i: number) => (
                  ...
                  >
                    <span className="text-base font-bold group-hover:underline line-clamp-2">
                      {item.title}
                    </span>
      ...
      <div>
        <h2 className="py-4 text-xl font-medium">Sector Performance</h2>
        <Card>
